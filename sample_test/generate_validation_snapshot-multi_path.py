...
def main():
    # --- 路径配置 ---
    input_file = r"D:\paper\Synthtic_edit_sequence\lintseq\solhint\DATA\process_merge_test_data\process_merge_test_data.jsonl"

    # 输出文件 (必须带后缀 .jsonl)
    output_file = r"D:\paper\Synthtic_edit_sequence\lintseq\solhint\DATA\3path_process_merge_test_data\3path_process_merge_test_data.jsonl"
