...
if __name__ == "__main__":
    # 修改路径
    input_jsonl = r"D:\paper\Synthtic_edit_sequence\lintseq\solhint\DATA\merge_test_data\test_merged.jsonl"

    # 这个文件将只包含 {"contract": "..."}
    output_jsonl = r"D:\paper\Synthtic_edit_sequence\lintseq\solhint\DATA\process_merge_test_data\process_merge_test_data.jsonl"
